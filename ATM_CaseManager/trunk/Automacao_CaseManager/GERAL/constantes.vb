...
Module constantes
    ...
    'usuarios do case
    Public UsuarioLogado As String = ConfigurationManager.AppSettings("UsuarioLogado0")
    Public SenhaUsuarioLogado As String = GetConfig("SenhaUsuarioLogado0")
    Public INTERVALO_IMPORTACAO_HORAS As Integer = ConfigurationManager.AppSettings("INTERVALO_IMPORTACAO_HORAS")
    Public INTERVALO_IMPORTACAO_COMPLETA() As String = Split(ConfigurationManager.AppSettings("INTERVALO_IMPORTACAO_COMPLETA"), ",")
    'Dim intervaloA() As String = {INTERVALO_IMPORTACAO_COMPLETA(0), INTERVALO_IMPORTACAO_COMPLETA(1), INTERVALO_IMPORTACAO_COMPLETA(2)}
    'Public resultadoA() As String = {0, 0, 0}
    ...
    'Banco de dados Alerta digital
    Public BD_ALERTA_DIGITAL As String = ConfigurationManager.AppSettings("BD_ALERTA_DIGITAL")
    ...
    Public ciclos_maximo As Integer = ConfigurationManager.AppSettings("CICLOS")
    Public chave_exclusao As String = ConfigurationManager.AppSettings("CHAVE_EXCLUSAO")
